...
public class PersonTrainVerifyDBOpenHelper extends SQLiteOpenHelper {
	private static final String DATABASE_NAME = "facejoy.db";
	public static final String DATABASE_TABLE = "person_train_verify";
	...
	public static final String KEY_STATUS = "STATUS_COLUMN";
	...
	public static final String KEY_RESULT = "RESULT_COLUMN";
	...
	public PersonTrainVerifyDBOpenHelper(Context context) {
		this(context, DATABASE_NAME, null, DATABASE_VERSION);
	}
	
	public PersonTrainVerifyDBOpenHelper(Context context, String name, CursorFactory factory, int version) {
