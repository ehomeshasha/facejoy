package ca.dealsaccess.facejoy.image;
...
public class ImageManager {
	...
	private void setImageBitmap(ImageView imageView, Bitmap bitmap,
		...
		if (isTran) {
		    ...
		    //int height = (int) ((float) imageView.getWidth()/td.getMinimumWidth() * td.getMinimumHeight());
...
//		}
	...
	public boolean ismImageLoaderIdle() {
		return mImageLoaderIdle;
	}
